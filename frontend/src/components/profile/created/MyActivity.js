            ...
            <div className="card w-100 mt-4 mb-4 ps-3 pe-3">
                <div className="card-body d-flex row">
                    ...
                    <div className={"col-2 d-none d-md-flex justify-content-end align-items-center"}>
                        <Link title="Rediger aktivitet" to={`/activity/${this.props.data.id}/edit`} className={"btn btn-success"}><i className="fas fa-pen"/></Link>
                    </div>
                    <div className={"col-12 d-md-none mt-2 mb-2"}>
                        <Link to={`/activity/${this.props.data.id}/edit`} className={"btn btn-success w-100"}>Rediger</Link>
                    </div>
                </div>
            </div>
        );
